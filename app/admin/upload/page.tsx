...
export default function AdminUploadPage() {
  ...
  const [metadata, setMetadata] = useState<FormMetadata>({
    ...
    key: '',
    vocalist_type: 'male',
    is_ai_generated: true, // Default to AI for platform uploads
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      if (files.acapella) {
        ...
        uploadedUrls.acapella_url = path
      }
      ...
      // 3. Create track record via admin API (auto-approved)
      ...
      const trackPayload = {
        ...
        license_limit: metadata.license_limit || null,
        price_non_exclusive: metadata.price_non_exclusive || null,
        price_exclusive: metadata.price_exclusive,
        lyrics: files.lyrics || null,
        preview_clip_start: files.preview_clip_start || '0',
    ...
    <div className="mx-auto max-w-3xl">
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-text-secondary">
          Upload tracks as the Featune platform creator. Tracks are auto-approved.
        </p>
      </div>
      ...
      <div className="mt-8">
        ...
        {currentStep === 4 && (
          <StepSubmit
            ...
            onGoToTracks={() => router.push('/admin/tracks')}
          />
        )}
      </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-accent/30 bg-accent/5 px-4 py-3 text-sm text-accent">
        This track will be uploaded as platform content under the &quot;Featune&quot; creator and auto-approved.
      </div>
...
function StepSubmit({
  ...
  if (submitSuccess) {
    return (
      <div className="rounded-xl border border-success/30 bg-success/10 p-8 text-center">
        ...
        <h2 className="mb-2 text-xl font-bold text-text-primary">Track Published!</h2>
        <p className="mb-6 text-sm text-text-secondary">
          Your track has been uploaded and is now live on the platform.
        </p>
        <button
  ...
  return (
    <div className="rounded-xl border border-border-default bg-bg-elevated p-8 text-center">
      ...
      <h2 className="mb-2 text-lg font-semibold text-text-primary">Ready to Publish</h2>
      <p className="mb-4 text-sm text-text-secondary">
        This track will be immediately published under the Featune creator.
      </p>
